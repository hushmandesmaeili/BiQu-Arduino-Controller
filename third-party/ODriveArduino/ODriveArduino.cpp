...
void ODriveArduino::SetBatchPosition(float position0, float position1) {
    serial_ << "b " << position0 << " " << position1 << "\n";
}
...
String ODriveArduino::readState(){
    serial_ << "f\n";
    return readString(); 
}
